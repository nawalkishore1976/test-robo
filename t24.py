...
class RobotSimulationV14:
    ...
    def simulate_robot_step_fixed(self, target_wp: WayPoint, dt: float) -> RobotState:
        ...
        # Expected wheel speeds from target waypoint
        ...
        # Expected kinematics using same formulas as actual
        ...
        target_wp.expected_total_turn_step = target_wp.expected_total_turn
